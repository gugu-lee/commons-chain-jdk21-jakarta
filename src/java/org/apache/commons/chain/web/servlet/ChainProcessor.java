 ...
 *
 * <p>
 * In addition to the <em>servlet</em> init parameters supported by
 ...
 *
 * <p>
 * Also, the <code>org.apache.commons.chain.CONFIG_ATTR</code>
...
public class ChainProcessor extends ChainServlet {
    ...
    public void service(HttpServletRequest request,
        ...
        if (attribute != null) {
            theCatalog = (Catalog) getServletContext().getAttribute(this.attribute);
